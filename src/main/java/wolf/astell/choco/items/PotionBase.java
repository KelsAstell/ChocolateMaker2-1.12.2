...
public class PotionBase extends ItemFood {

	private final PotionEffect[] effect;
	private final ItemStack returnItem;

	public PotionBase(String name, PotionEffect[] effects, ItemStack returnItem) {
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add(I18n.format("item."+ stack.getUnlocalizedName() +".desc"));
	}
}
...
package wolf.astell.choco.items.potions;
...
public class PotionMod extends Potion {
	...
	private static final ResourceLocation resource = new ResourceLocation(Main.MODID,"textures/icons/potions.png");
	private final int iconIndex;

	public PotionMod(String name, boolean badEffect, int color, int iconIndex) {
		super(badEffect, color);
		setRegistryName(new ResourceLocation(Main.MODID, name));
		setPotionName("choco.potion." + name);
